...
export class PhotoResolverBase {
  ...
  async DeletePhoto(
    ...
    return this.service.DeletePhoto(args);
  }

  @graphql.Query(() => [Event])
  async GetEventPhotos(
    @graphql.Args()
    args: EventFindManyArgs
  ): Promise<Event[]> {
    return this.service.GetEventPhotos(args);
  }

  @graphql.Query(() => EventCountArgs)
  async GetPresignedUrl(
    @graphql.Args()
    args: EventCountArgs
  ): Promise<EventCountArgs> {
    return this.service.GetPresignedUrl(args);
  }
}
